...
public class Quiz extends AppCompatActivity {
    ...
    String quizData[][] = {
            ...
            {"Name the seventh planet from the sun.","Uranus","Neptune","Jupiter","Saturn"},
            {"Name the world's biggest island.","Greenland","Philippines","Borneo","Madagascar","New Guinea"},
            {"Name the three primary colours.","Red, yellow and blue", "Red, blue and green", "Black, white and gray", "Black, blue and red"},
            ...
            {"Which two numbers are used in binary code?","0 and 1","1 and 2","3 and 6","0 and 9"},
